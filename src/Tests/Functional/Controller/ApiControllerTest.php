...
namespace Evrinoma\MailBundle\Tests\Functional\Controller;

use Evrinoma\MailBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.mail.test.functional.action.mail';
    ...
    {
        return [FixtureInterface::MAIL_FIXTURES];
    }
}
