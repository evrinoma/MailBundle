...
namespace Evrinoma\MailBundle\Facade\Mail;

use Evrinoma\MailBundle\Manager\CommandManagerInterface;
use Evrinoma\MailBundle\Manager\QueryManagerInterface;
use Evrinoma\MailBundle\PreValidator\DtoPreValidatorInterface;
